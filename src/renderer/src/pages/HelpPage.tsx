...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Игры часто перехватывают ввод. Запустите RPBINDER от имени администратора — тогда низкоуровневый хук сможет ловить нажатия поверх игры.'
  },
  {
    ...
    <>
      ...
      <div className="content-scroll">
        ...
        <div className="empty" style={{ paddingTop: 24 }}>
          RPBINDER · клон-проект для обучения · v0.1.0
        </div>
      </div>
    </>
  )
